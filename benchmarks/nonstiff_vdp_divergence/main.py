...
actual distribution of accepted plus rejected Tsit5 steps. torchdiffeq's Dopri8
takes one adaptive step for the whole ensemble, so its time is set by the
trajectory wanting the smallest step.

Usage:
    uv run python benchmarks/nonstiff_vdp_divergence/main.py
"""
